...
@section('title', __('legalitas.page_title') . ' | Yayasan Sains Nusantara')
@section('meta_description', __('legalitas.page_description'))
@section('meta_keywords', 'legalitas, profil, NIB, NPWP, Yayasan Sains Nusantara')
