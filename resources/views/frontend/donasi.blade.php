                    ...
                    <div class="mx-auto text-justify" style="max-width:800px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-sm btn-outline-primary ms-2 btn-copy" onclick="copyRekening()" title="Salin No. Rekening">
                        ...
                        <ul class="donasi-konfirmasi-list">
                            <li>
                                ...
                                Email: <a href="mailto:yayasansainsnusantara@gmail.com " class="text-primary fw-semibold">yayasansainsnusantara@gmail.com </a>
                            </li>
                            <li>
                                <i class="ti-mobile me-2 text-primary"></i>
                                WhatsApp: <a href="https://wa.me/6285260000000" target="_blank" class="text-primary fw-semibold">0852 6000 0000</a>
                            </li>
                        </ul>

                        <p class="text-muted small mt-3">
                            <i class="ti-info-alt me-1"></i>
                            Sertakan bukti transfer, nama lengkap, dan pesan/tujuan donasi agar kami dapat mencatatnya dengan baik.
                        </p>
                    </div>
                </div>
