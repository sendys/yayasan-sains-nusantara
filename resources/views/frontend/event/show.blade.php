...
@section('title', $event->title . ' | Publikasi | Yayasan Sains Nusantara')
@section('meta_description', $event->description ?? Str::limit(strip_tags($event->content ?? $event->title), 150))
@section('meta_keywords', $event->category ?? 'kegiatan, publikasi')
@section('canonical', route('frontend.event.show', $event->uuid))
                        ...
                        @if ($event->max_participants)
                            <div class="mt-4">
                                ...
                                <div class="progress" style="height: 25px;">
                                    ...
                                    @endphp
                                    <div class="progress-bar bg-{{ $event->is_full ? 'danger' : 'success' }}"
                                ...
                                @foreach ($relatedEvents as $related)
                                    <div class="media mb-3">
                                        ...
                                        <img src="{{ $related->image_url }}" alt="{{ e($related->title) }}"
                                            class="mr-3 rounded" style="width:80px; height:60px; object-fit:cover;">
