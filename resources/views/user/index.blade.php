...
@section('content')
    <?php
    $sub_title = 'Tables';
    $title = 'Manage Users' . (Auth::user()->perusahaan?->name ? ', ' . Auth::user()->perusahaan->name : '');
    ?>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-auto">
                            <form method="GET" action="{{ route('user.index') }}"
                                ...
                                <div class="me-3">
                                    <input type="search" name="search" class="form-control form-control-sm my-1 my-lg-0"
                                        id="search" placeholder="Search..." value="{{ request('search') }}">
                                </div>
                                <label for="status-select" class="me-2">Show</label>
                                <div class="me-sm-3">
                                    <select class="form-select form-select-sm my-1 my-lg-0" name="per_page"
                        ...
                        <div class="col-auto">
                            <div class="text-lg-end my-1 my-lg-0">
                                <button type="button" class="btn btn-success btn-sm waves-effect waves-light mb-2 me-1"><i
                                ...
                                <a href="{{ route('user.create') }}"
                                    class="btn btn-danger btn-sm waves-effect waves-light mb-2">Add User</a>
                            </div>
                        </div><!-- end col-->
                    </div>
                    <br>
