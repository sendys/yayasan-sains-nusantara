                    ...
                    <form action="{{ route('akun.update', $account->id) }}" method="POST" class="parsley-examples">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="account_code" name="account_code"
                                ...
                                placeholder="kode akun" class="form-control form-control-sm" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="account_name" name="account_name"
                                ...
                                placeholder="nama akun" class="form-control form-control-sm" />
                        ...
                        <div class="text-end">
                            <button class="btn btn-primary btn-sm waves-effect waves-light" type="submit">Simpan</button>

                            <a href="{{ route('akun.index') }}" class="btn btn-secondary btn-sm waves-effect">Kembali</a>
