...
@section('title', __('kontak.page_title') . ' | Yayasan Sains Nusantara')
@section('meta_description', __('kontak.page_description'))
@section('meta_keywords', 'kontak, alamat, telepon, email, Yayasan Sains Nusantara')
