        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="eventForm" method="POST" action="{{ route('admin.event.update', $event->uuid) }}"
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                        rows="3" maxlength="500">{{ old('description', $event->description) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="10">{{ old('content', $event->content) }}</textarea>
                            ...
                            <div class="col-12 col-lg-4">
                                        ...
                                        @if ($event->image && Storage::disk('public')->exists($event->image))
                                            <div class="mb-2">
                                                <img id="imagePreview" src="{{ asset('storage/' . $event->image) }}"
                                                    alt="{{ $event->title }}" class="img-thumbnail"
                                                    style="max-width: 100%;">
                                            </div>
                                        @else
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" id="status"
                                        ...
                                        <option value="draft"
                                            {{ old('status', $event->status) == 'draft' ? 'selected' : '' }}>Draft</option>
