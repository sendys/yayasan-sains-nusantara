            ...
            <div class="card">
                <div class="card-body">
                    <p class="text-muted font-14">
                        Halaman ini digunakan untuk menambah data Tentang Kami yang ditampilkan di halaman frontend. <br>
                        Data ini mencakup Logo, Deskripsi, Visi, dan Misi organisasi.
                    </p>
                    <hr class="my-1">
                    <br>

                    <form id="tentangForm" action="{{ route('admin.tentang.store') }}" method="POST"
                                    ...
                                    <div class="card-body text-center">
                                        <div class="mb-3">
                                            <img id="logoPreview" src="{{ asset('assets/images/placeholder.png') }}"
                                                alt="Preview" class="img-fluid rounded d-none" style="max-height: 200px;">
