...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mb-3">Edit Data Galeri</h4>

                    <form id="galleryForm" method="POST" action="{{ route('admin.gallery.update', $gallery->uuid) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4">{{ old('deskripsi', $gallery->deskripsi) }}</textarea>
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <div class="mt-2">
                                        @if ($gallery->image)
                                            <img id="imagePreview" src="{{ asset('storage/' . $gallery->image) }}" alt="Preview"
