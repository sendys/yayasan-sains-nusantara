...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Bulk Import Data Satuan</h4>
                    <p class="sub-header">
                        <code style="font-weight: bold; font-size: 15px;">Import Data Satuan</code>
                        <span style="font-weight: bold; font-size: 12px;">dari file CSV untuk menambahkan multiple data
                            sekaligus.</span>
                    </p>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card border border-primary">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('satuan.process-bulk-import') }}" method="POST"
                        ...
                        <div class="col-md-4">
                            <div class="card border border-info">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('satuan.download-template') }}" class="btn btn-info btn-block w-100">
