            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">
                        Silakan lengkapi data perusahaan baru pada form di bawah ini. Pastikan mengisi data dengan benar, <br>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('is_status') is-invalid @enderror" id="is_status" name="is_status">
                                        <option value="1" {{ old('is_status', '1') == '1' ? 'selected' : '' }}>Aktif</option>
                                        <option value="0" {{ old('is_status') == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                                    </select>
                                    @error('is_status')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('is_premium') is-invalid @enderror" id="is_premium" name="is_premium">
                                        <option value="0" {{ old('is_premium', '0') == '0' ? 'selected' : '' }}>Regular</option>
